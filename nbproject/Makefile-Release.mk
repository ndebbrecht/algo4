...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/algo_4

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/algo_4: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/algo_4 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/PQ_Dijkstra.o: PQ_Dijkstra.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PQ_Dijkstra.o PQ_Dijkstra.cpp
